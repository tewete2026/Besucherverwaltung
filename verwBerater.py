...
def main():
    ...
    conf = Configure(title="Verwalten Berater", header=["Beraterin/Berater Nr.", "Neuen Beraterin/Berater erfassen"], prefix="03", app='coaches', 
                     link='link-verwberater', label="Berater", category="Beraterin/Berater", overview="Übersicht Beraterin/Berater", pag_search="oder Suchbegriff eingeben", pag_type="text", 
