...
def main():
    ...
    conf = Configure(request, current_app, title="Verwalten Veranstaltungsarten", header=["Veranstaltungsart Nr.", "Neue Veranstaltungsart erfassen"], prefix="06", app='veransttyp', username=session['coach_name'],
