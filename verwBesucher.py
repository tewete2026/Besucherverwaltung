...
def main():
    ...
    conf = Configure(title="Verwalten Besucher", header=["Besucherin/Besucher Kund.-Nr.", "Neuen Besucherin/Besucher erfassen"], prefix="02", app='visiter', 
                     link='link-verwbesucher', label="Besucher", category="Besucherin/Besucher", overview="Übersicht Besucherin/Besucher", pag_search="oder Suchbegriff eingeben", pag_type="text", 
                     request=request, current_app=current_app)
