...
def create_app(test_config="DEV"):
    ...
    dictConfig({
        ...
        'handlers': {
            ...
            "smtp": {
                ...
                "toaddrs": "thomas@thomsen-privat.de",
    ...
    app = Flask(version.Configs.APP_NAME, instance_relative_config=True, static_url_path=f"/{version.Configs.APP_NAME}/script")
    app.config.from_mapping(
        # a default secret that should be overridden by instance config
        SECRET_KEY="zq2hdgd5fgrt46te",
        TEST_RUN=False,
        DB_POOL=None,
    ...
    from . import main
    from . import ax_visiter
    from . import ax_events
    from . import ax_coaches
    from . import ax_devices
    from . import ax_eventtypes
    from . import ax_themes
    from . import ax_targets
    from . import ax_default
    from . import yx_gen_service
    from . import verwBesucher
    from . import verwBerater
    from . import verwVeranstTyp
    from . import verwThemen
    from . import verwGeraete
    from . import verwOrte
